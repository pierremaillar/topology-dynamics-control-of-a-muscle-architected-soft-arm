__doc__ = """Hierarchical muscle torques of Elastica Numba implementation"""
import numpy as np
import numba
from elastica.external_forces import NoForces

from elastica._elastica_numba._linalg import _batch_matvec, _batch_product_i_k_to_ik
